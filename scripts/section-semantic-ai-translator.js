...
// Translate (decode/encode) docs/search/section-semantic.ai.v1.json.gz (gzip JSON) to readable formats.
//
// Usage:
//   node scripts/section-semantic-ai-translator.js dump --input docs/search/section-semantic.ai.v1.json.gz --output /tmp/section-semantic.ai.v1.json
//   node scripts/section-semantic-ai-translator.js dump --input docs/search/section-semantic.ai.v1.json.gz --output /tmp/section-semantic.ai.v1.yml
//   node scripts/section-semantic-ai-translator.js pack --input /tmp/section-semantic.ai.v1.json --output docs/search/section-semantic.ai.v1.json.gz
//
// Notes:
