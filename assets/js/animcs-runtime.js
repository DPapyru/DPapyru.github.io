...
(function (root, factory) {
    ...
    function inferRuntimeRootFromScriptSrc(src) {
        ...
        if (!raw) return '';
        return raw.replace(/\/assets\/js\/animcs-runtime\.js(?:\?.*)?$/i, '/assets/anims/runtime/');
    }
    ...
    async function defaultLoadDotnetModule(urls) {
        ...
        const creator = mod.createDotnetRuntime || (mod.dotnet && mod.dotnet.create);
        if (!creator) {
