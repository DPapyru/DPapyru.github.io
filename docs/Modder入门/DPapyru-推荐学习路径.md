...
8. 实作（进阶）：学习高级运动模式（冲刺/追踪/回旋镖/曲线）
   - [数学：弹幕 AI 常用数学与运动模式](文章使用内容索引/数学/DPapyru-弹幕AI数学与运动模式.md)
9. 实作：做一个持续生效的饰品（理解 UpdateAccessory 与 ModPlayer）
   - [第一个饰品：让效果随装备生效](1-入门/DPapyru-第一个饰品.md)
10. 资源：遇到贴图/声音问题，再回看"资源与路径规则"
{else}
