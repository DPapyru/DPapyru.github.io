...
internal static partial class CanvasInterop
{
    ...
    [JSImport("line", "animcs")]
    internal static partial void Line(int canvasId, float x1, float y1, float x2, float y2, byte r, byte g, byte b, byte a, float width);

    [JSImport("circle", "animcs")]
    internal static partial void Circle(int canvasId, float cx, float cy, float radius, byte r, byte g, byte b, byte a, float width);
