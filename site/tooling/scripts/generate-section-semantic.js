...
// Output: site/content/search/section-semantic.ai.v1.json.gz (binary, gzip JSON)
//
// Env:
// - LLM_API_KEY (required)
// - LLM_BASE_URL (required, OpenAI-compatible base URL, e.g. https://.../v1)
// - LLM_MODEL (optional, default: glm-4.7-flash)
// - SECTION_SEMANTIC_AI_PATH (optional, default: site/content/search/section-semantic.ai.v1.json.gz)
...
// - Legacy YAML (site/content/search/section-semantic.v1.yml) is supported as input for migration.
...
const DEFAULT_AI_OUT = path.join('site', 'content', 'search', 'section-semantic.ai.v1.json.gz');
const LEGACY_YAML = path.join('site', 'content', 'search', 'section-semantic.v1.yml');
