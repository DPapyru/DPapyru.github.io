...
public sealed class Vec2BasicOps : IAnimScript
{
    ...
    {
        _ctx = ctx;
        _cursor = new Vector2(0.45f, 0.2f);
        _mode = 0;
    }
    ...
    public void OnRender(ICanvas2D g)
    {
        ...
        g.Text("Vector2 Basic Ops", new Vector2(12f, 12f), new Color(225, 235, 245, 240), 13f);
        g.Text("模式: " + label, new Vector2(12f, 30f), new Color(160, 198, 230, 220), 12f);
        g.Text("蓝: a  橙: b  绿: result", new Vector2(12f, 48f), new Color(130, 150, 175, 220), 12f);
    }
