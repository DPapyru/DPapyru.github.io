        ...
        OnRender(g) {
            ...
            switch (mode) {
                ...
                case 3:
                    ...
                    break;
                default:
                    model = Matrix.Multiply(Matrix.Multiply(translate, rotate), scaling);
                    break;
            }
            ...
            Mat4TrsCompose.DrawArrow3(g, Matrix.TransformVector3(view, new Vector3(0, 0, 0)), Matrix.TransformVector3(view, new Vector3(1.2, 0, 0)), new Color(255, 110, 110, 220), 1.8, center, scale);
            Mat4TrsCompose.DrawArrow3(g, Matrix.TransformVector3(view, new Vector3(0, 0, 0)), Matrix.TransformVector3(view, new Vector3(0, 1.2, 0)), new Color(120, 255, 140, 220), 1.8, center, scale);
            Mat4TrsCompose.DrawArrow3(g, Matrix.TransformVector3(view, new Vector3(0, 0, 0)), Matrix.TransformVector3(view, new Vector3(0, 0, 1.2)), new Color(120, 170, 255, 220), 1.8, center, scale);
            ...
            g.Text("Matrix TRS Compose", new Vector2(12, 12), new Color(220, 230, 245, 220), 13);
            g.Text("\u6A21\u5F0F: " + Mat4TrsCompose.ModeName(mode), new Vector2(12, 30), new Color(140, 185, 228, 210), 12);
            g.Text("\u62D6\u62FD\u65CB\u8F6C\u89C6\u89D2\uFF0Cmode-select \u5207\u6362 T/R/S", new Vector2(12, 46), new Color(130, 150, 175, 210), 12);
        }
        OnDispose() {
        }
