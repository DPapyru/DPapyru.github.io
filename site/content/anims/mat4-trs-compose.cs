...
public sealed class Mat4TrsCompose : IAnimScript
{
    ...
    public void OnRender(ICanvas2D g)
    {
        ...
        g.Text("Matrix TRS Compose", new Vector2(12f, 12f), new Color(220, 230, 245, 220), 13f);
        g.Text("模式: " + ModeName(mode), new Vector2(12f, 30f), new Color(140, 185, 228, 210), 12f);
        g.Text("拖拽旋转视角，mode-select 切换 T/R/S", new Vector2(12f, 46f), new Color(130, 150, 175, 210), 12f);
    }
