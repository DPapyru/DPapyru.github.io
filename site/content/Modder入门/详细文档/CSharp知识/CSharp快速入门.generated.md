...
next_chapter: CSharp基本语法
---

## 版本说明

> WARNING: 版本说明：本教程基于 **C# 10.0 / .NET 8**，适用于 tModLoader 1.4.4+
>
> 如果你使用的是旧版 tModLoader（1.3 或更早），C# 语法略有差异（例如 `var` 类型推断）。
...
## 关键字：public / private / protected / internal
...
<!-- generated from: Modder入门/详细文档/CSharp知识/CSharp快速入门.cs -->
