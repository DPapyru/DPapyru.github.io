...
namespace ModDocProject.Modder入门.详细文档.CSharp知识 {
    #region 元数据
    /// <summary>理解“类/实例/继承”，能看懂 tModLoader 的 API 结构</summary>
    [Title("C#面向对象基础")]
    [Tooltip("理解“类/实例/继承”，能看懂 tModLoader 的 API 结构")]
    ...
    [Difficulty("beginner")]
    [Time("20分钟")]
    [PrevChapter("CSharp数组与集合")]
    [NextChapter("CSharp高级特性")]
    #endregion
    public class CSharp面向对象基础 {
#if DOCS
        #region 面向对象：为什么教程里全是 class
