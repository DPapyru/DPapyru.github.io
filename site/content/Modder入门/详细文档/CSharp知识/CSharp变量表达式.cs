...
namespace ModDocProject.Modder入门.详细文档.CSharp知识 {
    #region 元数据
    /// <summary>把“变量是什么、表达式怎么写、为什么会报错”一次讲清</summary>
    [Title("C#变量与表达式")]
    [Tooltip("把“变量是什么、表达式怎么写、为什么会报错”一次讲清")]
    ...
    [Difficulty("beginner")]
    [Time("15分钟")]
    [PrevChapter("CSharp基本语法")]
    [NextChapter("CSharp控制流")]
    #endregion
    public class CSharp变量表达式 {
#if DOCS
        #region 变量：名字 + 类型 + 生命周期
        ...
        #region 示例代码：把表达式放进 tModLoader SetDefaults
