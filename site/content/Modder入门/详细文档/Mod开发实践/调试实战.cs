...
namespace ModDocProject.Modder入门.详细文档.Mod开发实践 {
    #region 元数据
    /// <summary>通过具体案例学习调试技巧和问题排查流程</summary>
    [Title("调试实战 - 问题排查流程")]
    [Tooltip("通过具体案例学习调试技巧和问题排查流程")]
