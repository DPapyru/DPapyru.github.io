...
export function create(runtime) {
    ...
    class DemoEocAi {
        ...
        OnInit(ctx) {
            ...
            this._minionPos = [new Vec2(0, 0), new Vec2(0, 0), new Vec2(0, 0), new Vec2(0, 0), new Vec2(0, 0), new Vec2(0, 0)];
            this._minionVel = [new Vec2(0, 0), new Vec2(0, 0), new Vec2(0, 0), new Vec2(0, 0), new Vec2(0, 0), new Vec2(0, 0)];
        ...
        UpdateMinions(target, dt) {
            for (let i = 0; i < this._minionActive.length; i++)
            {
                ...
                let desired = new Vec2(target.X + MathF.Cos(orbitAngle) * orbitRadius, target.Y + MathF.Sin(orbitAngle) * orbitRadius);
        ...
        static DrawEye(g, center, target, isPhase2, time) {
            ...
            for (let i = 0; i < 8; i++)
            {
                ...
                let end = new Vec2(center.X + dir.X * (bodyRadius + 10 + 6 * MathF.Sin(time + i)), center.Y + dir.Y * (bodyRadius + 10 + 6 * MathF.Sin(time + i)));
