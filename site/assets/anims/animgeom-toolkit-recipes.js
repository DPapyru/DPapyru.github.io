...
export function create(runtime) {
    ...
    class AnimgeomToolkitRecipes {
        ...
        OnRender(g) {
            ...
            g.Text("AnimGeom Toolkit Recipes", new Vector2(12, 12), new Color(225, 235, 245, 235), 13);
            g.Text(mode == 1 ? "\u6A21\u5F0F: \u8F68\u8FF9\u91C7\u6837" : "\u6A21\u5F0F: \u5750\u6807\u8F74\u002B\u7BAD\u5934", new Vector2(12, 30), new Color(155, 190, 225, 220), 12);
            g.Text("\u6F14\u793A ToScreen / DrawAxes / DrawArrow \u5E38\u89C1\u7EC4\u5408", new Vector2(12, 48), new Color(130, 150, 175, 220), 12);
        }
        OnDispose() {
        }
        DrawArrowRecipes(g, center, scale) {
            let t = this._ctx == null ? 0 : this._ctx.Time;
            let vectors = [new Vector2(MathF.Cos(t * 0.8) * 1.1, MathF.Sin(t * 0.8) * 0.7), new Vector2(MathF.Cos(t * 1.1 + 1.3) * 0.8, MathF.Sin(t * 1.1 + 1.3) * 1), new Vector2(MathF.Cos(t * 1.5 + 2.4) * 0.6, MathF.Sin(t * 1.5 + 2.4) * 0.55)];
        ...
        DrawOrbitSamples(g, center, scale) {
            ...
            while (i < 20)
            {
                ...
                let p = new Vector2(MathF.Cos(t) * 1.1, MathF.Sin(t * 1.4) * 0.6);
            ...
            let current = new Vector2(MathF.Cos(this._ctx.Time) * 1.1, MathF.Sin(this._ctx.Time * 1.4) * 0.6);
