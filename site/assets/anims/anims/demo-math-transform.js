// Generated from anims/demo-math-transform.anim.ts
...
export function create(runtime) {
    ...
    class DemoMathTransform {
        ...
        OnRender(g) {
            ...
            let scaleX = 1 + 0.18 * MathF.Sin(time * 0.4);
            let scaleY = 1 - 0.16 * MathF.Sin(time * 0.55);
            ...
            let m10 = sin;
            let m11 = cos * scaleY;
            let basisX = new Vector2(m00, m10);
            let basisY = new Vector2(m01, m11);
            let vector = new Vector2(1.1, 0.6);
        ...
        static DrawUnitSquare(g, center, scale, m00, m01, m10, m11) {
            ...
            let points = [new Vector2(0, 0), new Vector2(1, 0), new Vector2(1, 1), new Vector2(0, 1)];
