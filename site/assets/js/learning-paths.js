...
(function () {
    ...
    function getMappingUrl() {
        return '/site/assets/learning-paths.v1.json';
    }
    ...
    function normalizePath(value) {
        ...
        // config.json 的 doc.path 是以 content/ 目录为根的相对路径；
        // learning-paths 映射可能使用 site/content 前缀，这里统一去掉前缀。
        p = p.replace(/^site\/content\//, '');
        p = p.replace(/^content\//, '');
    ...
    function normalizeMapping(mapping) {
        ...
        // 归一化 docRules 的 key，避免 site/content/ 前缀不一致导致全量“未标注”。
