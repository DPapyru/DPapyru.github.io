...
// Provides a single source of truth for site/content/config.json loading across pages.
(function () {
  var state = {
    promise: null,
    config: null,
  ...
  function getConfigPath() {
    return '/site/content/config.json';
  }
